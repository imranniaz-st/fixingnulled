...
@section('contents')
    <div class="h-screen w-full flex items-center relative" data-aos="zoom-in-up">
        <img src="{{ asset('/assets/templates/valent/images/other-crypto-coins-revolve-around-bitcoin-3d-rendering-b 1.png') }}"
            alt="crypto" class="w-[924px] absolute right-0 lg:block hidden" id="formImage">
        <img src="{{ asset('/assets/templates/valent/images/blockchain-3d-render-icon-b 1.png') }}" alt="crypto"
            class="w-[924px] absolute right-0 lg:block hidden" id="formImageOtp">
            ...
            <div class="col-span-1">
                ...
                <div class="max-w-screen-sm mx-auto" data-aos="fade-right">
                    ...
                    <div class="text-white mb-10">
                        <p class="text-4xl mb-4 font-thin">Forget <span
                                class="font-bold bg-gradient-to-r from-[#3F7DF2] via-[#09C241] to-[#ffffff] bg-clip-text text-transparent">Password</span>
                        </p>
                        <p class="" id="formTitle">Enter your email address</p>
                    </div>


                    <form action="{{ route('user.forgot-password.send') }}" method="POST" id="registerForm">
                        @csrf
                        <div class="w-full mb-10">
                            <fieldset class="border py-1 px-3 rounded-2xl">
                                <legend class="px-3 mx-8 text-white"><label for="email" class="text-white text-sm">Email
                        ...
                        <div class="w-full mb-4 pt-10">
                            <div class="text-center">
                                <button type="submit" id="registerBtn"
                                    class="border bg-gradient-to-r from-[#3271E8] to-[#0A4AC5] text-white hover:bg-blue-600 rounded-full px-10 py-4 w-full hover:text-[#0040BC] hover:bg-gradient-to-r hover:from-[#3F7DF2] hover:via-[#FFFFFF] hover:to-[#09C241] transition delay-100 duration-200 ease-in-out">Forget</button>
                            </div>
                        </div>

                        <div class="w-full mb-4">
                            <p class="text-center text-[#B4B1B1]"> Go back to <a href="{{ route('user.login') }}"
                    ...
                    <form action="{{ route('user.forgot-password.validate') }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 py-4">
                            <div class="relative">
                                <div class="border py-1 px-3 rounded-2xl">
                                    <div class="w-full text-white flex gap-4">
                        ...
                        <div class="w-full mb-4 pt-10">
                            <div class="text-center">
                                <button type="submit" id="verifyBtn"
                                    class="border bg-gradient-to-r from-[#3271E8] to-[#0A4AC5] text-white hover:bg-blue-600 rounded-full px-10 lg:py-4 py-2 w-full hover:text-[#0040BC] hover:bg-gradient-to-r hover:from-[#3F7DF2] hover:via-[#FFFFFF] hover:to-[#09C241] transition delay-100 duration-200 ease-in-out">Save</button>
                            </div>

                            <div class="text-center text-white py-5">
                                <a href="{{ route('user.login') }}" class="hover:text-purple-700" id="resendBtn">Go
                                    Back</a>
                            </div>
                        </div>
                    </form>
